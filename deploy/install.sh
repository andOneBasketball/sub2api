...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/andOneBasketball/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="andOneBasketball/sub2api"
...
Documentation=https://github.com/andOneBasketball/sub2api
